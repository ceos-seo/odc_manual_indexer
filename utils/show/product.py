...
prd_df = pd.DataFrame(
    ...
    data=[
## Landsat
[ls5_c1_l2_product_type, 'ls5_usgs_sr_scene', 'N/A', '30m', 
 'EPSG:4326', 'Landsat/collection_1/prod_defs/ls5_usgs_sr_scene.yaml',
...
[sntnl2_l2a_product_type, 's2_l2a_aws_cog', 'Sentinel-2 L2A Cloud-Optimized GeoTIFFs at s3://sentinel-cogs/sentinel-s2-l2a-cogs', '10-60m',
 'varies', 'Sentinel-2/L2A/prod_defs/s2_l2a_aws_cog.yaml', 'N/A'],
## JERS-1 
